...
module.exports = function (line) {
  ...
  // Skip header lines like: "version account-id interface-id ..."
  if (/^\s*version\b/i.test(line)) {
    return null;
  }
  ...
  // Replace '-' values (including surrounding whitespace) with null to avoid data type conflicts in OpenSearch
